            ...
            <div>
                ...
                <div className="chat-container">
                    ...
                    <form className="chat-form" id="chat-form" onSubmit={handleSubmit}>
                        ...
                        />
                        {browserSupportsSpeechRecognition && <button type="button" onClick={handleMicIconClick} style={{ background: 'rgb(92 165 223)', color: '#ffffff', border: 'none', cursor: 'pointer', padding: '8px', marginRight: '5px', borderRadius: '30px' }}>
